		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#project1fiori1project1fiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project1fiori1project1fiori-display": {
								"semanticObject": "project1fiori1project1fiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1.fiori1.project1fiori",
									"url": sap.ui.require.toUrl("project1/fiori1/project1fiori")
								}
							}
						}
					}
